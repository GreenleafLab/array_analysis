...
python $GROUP_HOME/kyx/array_analysis/scripts/array_tools/array_data_processing/getRegistrationOffsets.py -id $GROUP_SCRATCH/kyx/NNNlib2b_Nov11/data/fiducial_images_20211223/ -sd /scratch/groups/wjg/kyx/NNNlib2b_Nov11/data/filtered_tiles/ -gv /oak/stanford/groups/wjg/kyx/software -f FID -od $GROUP_SCRATCH/kyx/NNNlib2b_Nov11/data/registration -op registration_offset_20211223
